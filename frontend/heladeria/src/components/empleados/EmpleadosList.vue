    ...
    <table>
      ...
      <tbody>
        <tr v-for="empleado in empleados" :key="empleado.id">
          ...
          <td>
            <router-link :to="{ name: 'empleados_edit', params: { id: empleado.id } }"
              >Editar</router-link
            >
            <router-link :to="{ name: 'empleados_show', params: { id: empleado.id } }"
              >Mostrar</router-link
            >
            <button @click="deleteEmpleado(empleado.id as number)">Eliminar</button>
          </td>
        </tr>
      </tbody>
    </table>
